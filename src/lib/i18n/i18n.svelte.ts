...
export const translations = {
    en: {
        ...
        drDetail: 'Dominican Republic 🇩🇴 · Company No. 937429 · ',
        jointVentures: 'Joint ventures',
        hyperiorDetail: 'United Kingdom 🇬🇧 · Company No. 17309416 · ',
        hyperiorStake: '50% Kodex Labs Ltd · 50% Atlantic Cedar Limited',
    ...
    es: {
        ...
        drDetail: 'República Dominicana 🇩🇴 · Sociedad N.º 937429 · ',
        jointVentures: 'Empresas conjuntas',
        hyperiorDetail: 'Reino Unido 🇬🇧 · Sociedad N.º 17309416 · ',
        hyperiorStake: '50% Kodex Labs Ltd · 50% Atlantic Cedar Limited',
